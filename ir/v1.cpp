...
IR::V1Program::V1Program(const Sizes &sizes) {
    // This should be kept in sync with v1model.p4
    auto *standard_metadata_t = new IR::Type_Struct("standard_metadata_t", {
        new IR::StructField("ingress_port",          IR::Type::Bits::get(sizes.ingress_port)),
        new IR::StructField("packet_length",         IR::Type::Bits::get(sizes.packet_length)),
        new IR::StructField("egress_spec",           IR::Type::Bits::get(sizes.egress_spec)),
        new IR::StructField("egress_port",           IR::Type::Bits::get(sizes.egress_port)),
        new IR::StructField("egress_instance",       IR::Type::Bits::get(sizes.egress_instance)),
        new IR::StructField("instance_type",         IR::Type::Bits::get(sizes.instance_type)),
        new IR::StructField("parser_status",         IR::Type::Bits::get(sizes.parser_status)),
        new IR::StructField("parser_error_location", IR::Type::Bits::get(sizes.parser_error_location)),
    });
